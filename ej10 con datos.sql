...
insert into liga (id_liga, nombre, temporada) values (7, '2.Bundesliga', '2020-2021');
...
SELECT * FROM partido;
insert into equipo_partido (id_equipo, id_partido, is_visitante) values (14, 1, TRUE);
insert into equipo_partido (id_equipo, id_partido, is_visitante) values (5, 1, FALSE);
insert into equipo_partido (id_equipo, id_partido, is_visitante) values (13, 3, TRUE);
insert into equipo_partido (id_equipo, id_partido, is_visitante) values (7, 10, FALSE);
insert into equipo_partido (id_equipo, id_partido, is_visitante) values (1, 5, TRUE);
insert into equipo_partido (id_equipo, id_partido, is_visitante) values (2, 5, FALSE);
insert into equipo_partido (id_equipo, id_partido, is_visitante) values (10, 7, TRUE);
insert into equipo_partido (id_equipo, id_partido, is_visitante) values (6, 7, FALSE);
insert into equipo_partido (id_equipo, id_partido, is_visitante) values (4, 3, FALSE);
insert into equipo_partido (id_equipo, id_partido, is_visitante) values (9, 10, TRUE);

SELECT * FROM equipo_partido;

SELECT ep.id_equipo, ep.id_partido, ep.is_visitante, p.resultado, p.fecha FROM 
equipo_partido AS ep, partido AS p 
WHERE p.id_partido = ep.id_partido;

SELECT ep.id_equipo, ep.is_visitante, e.nombre, ep.id_partido, p.resultado FROM equipo_partido ep
INNER JOIN equipo e ON ep.id_equipo = e.id_equipo 
INNER JOIN partido p ON p.id_partido = ep.id_partido;
